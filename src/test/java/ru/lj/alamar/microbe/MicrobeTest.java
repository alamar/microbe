...
public class MicrobeTest {
    ...
    public void testConversion() {
        ...
        microbe.mutate(r, 0f, 0f, 0f, 0f, 0.33f, 0f);
        assertArrayEquals(new float[] {0.99f, 0.99f, 0.99f, 0.99f, 0.495f, 0.495f, 0.99f, 0.99f, 0.991f, 0.99f}, microbe.getChromosomes()[0], 0.0005f);
        assertArrayEquals(new float[] {0.99f, 0.99f, 0.99f, 0.99f, 0.991f, 0.991f, 0.99f, 0.99f, 0.991f, 0.99f}, microbe.getChromosomes()[1], 0.0005f);
        assertEquals(1.003f, microbe.fitness(), 0.0005f);
    }
    ...
    public void testCrossing() {
        ...
        microbe.mutate(r, 0f, 0f, 0f, 0f, 0f, 0.33f);
        assertArrayEquals(new float[] {0.99f, 0.99f, 0.495f, 0.495f, 0.495f, 0.495f, 0.99f, 0.495f, 0.991f, 0.99f}, microbe.getChromosomes()[0], 0.0005f);
        assertArrayEquals(new float[] {0.99f, 0.99f, 0.99f, 0.99f, 0.991f, 0.991f, 0.99f, 0.99f, 0.991f, 0.99f}, microbe.getChromosomes()[1], 0.0005f);
        assertEquals(1.003f, microbe.fitness(), 0.0005f);
    }
