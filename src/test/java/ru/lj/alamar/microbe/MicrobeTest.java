...
public class MicrobeTest {
    ...
    public void testSelect() {
        Random r = new Random(0);
        Microbe good = new Microbe(0.99f, 1, 10, false, 2);
        assertEquals(1f, good.fitness(), 0.01f);

        Microbe bad = new Microbe(0.99f, 1, 10, false, 2);
        bad.mutate(r, 0.33f, 0.2f, 0.4f, 0.1f);
        assertEquals(0.5125f, bad.fitness(), 0.0005f);

        Microbe dead = new Microbe(0.99f, 1, 10, false, 2);
    ...
    public void testPloidy() {
        Microbe microbe = new Microbe(0.99f, 6, 10, false, 0);
        Random r = new Random(0);
        microbe.mutate(r, 0.33f, 0.5f, 0.4f, 0.1f);
    ...
    public void testDownsize() {
        Microbe microbe = new Microbe(0.99f, 2, 10, true, 1);
        Random r = new Random(0);
        microbe.mutate(r, 0.33f, 0.5f, 0.4f, 0.1f);
    ...
    public void testConversion() {
        Microbe microbe = new Microbe(0.99f, 2, 10, false, 0);
        Random r = new Random(0);
        microbe.mutate(r, 0.33f, 0.5f, 0.4f, 0.1f);
        ...
        assertArrayEquals(new float[] {0f, 0.99f, 0.99f, 0.495f, 0.99f, 0.495f, 0.495f, 0.99f, 0.99f, 0.991f, 0.99f}, microbe.getChromosomes()[0], 0.0005f);
        assertArrayEquals(new float[] {1f, 0.99f, 0.99f, 0.99f, 0.99f, 0.495f, 0.991f, 0.99f, 0.495f, 0.991f, 0.99f}, microbe.getChromosomes()[1], 0.0005f);
        assertEquals(0.501f, microbe.fitness(), 0.0005f);
    }

    @Test
    public void testCrossing() {
        Microbe microbe = new Microbe(0.99f, 2, 10, false, 1);
        Random r = new Random(0);
        microbe.mutate(r, 0.33f, 0.5f, 0.4f, 0.1f);

        assertEquals(1.003f, microbe.fitness(), 0.0005f);
        assertArrayEquals(new float[] {2f, 0.99f, 0.99f, 0.495f, 0.99f, 0.495f, 0.495f, 0.99f, 0.99f, 0.991f, 0.99f}, microbe.getChromosomes()[0], 0.0005f);
        assertArrayEquals(new float[] {3f, 0.99f, 0.99f, 0.99f, 0.495f, 0.991f, 0.991f, 0.99f, 0.495f, 0.991f, 0.99f}, microbe.getChromosomes()[1], 0.0005f);

        microbe.crossing(r);
        assertArrayEquals(new float[] {2f, 0.99f, 0.99f, 0.495f, 0.495f, 0.991f, 0.495f, 0.99f, 0.99f, 0.991f, 0.99f}, microbe.getChromosomes()[0], 0.0005f);
        assertArrayEquals(new float[] {3f, 0.99f, 0.99f, 0.99f, 0.99f, 0.495f, 0.991f, 0.99f, 0.495f, 0.991f, 0.99f}, microbe.getChromosomes()[1], 0.0005f);
        assertEquals(1.003f, microbe.fitness(), 0.0005f);
    }

    @Test
    public void testSubstitution() {
        Microbe donor = new Microbe(0.99f, 2, 10, false, 0);
        Random r = new Random(0);
        donor.mutate(r, 0.33f, 0.5f, 0.4f, 0.1f);
        assertEquals(1.003f, donor.fitness(), 0.0005f);

        Microbe receiver = new Microbe(0.99f, 2, 10, false, 0);
    ...
    public void testExchange() {
        Microbe first = new Microbe(0.99f, 2, 10, false, 1);
        Random r = new Random(0);
        first.mutate(r, 0.33f, 0.5f, 0.4f, 0.1f);
        assertEquals(1.003f, first.fitness(), 0.0005f);

        Microbe second = new Microbe(0.99f, 2, 10, false, 1);
    ...
    public void testHorizontalTransfer() {
        Random r = new Random(0);
        Microbe donor = new Microbe(0.99f, 1, 10, false, 1);
        Microbe receiver = new Microbe(0.99f, 1, 10, false, 0);
        donor.mutate(r, 0.33f, 0.5f, 0.4f, 0.1f);
        receiver.mutate(r, 0.33f, 0.5f, 0.4f, 0.1f);
